...
echo -e "\n"
echo -e "================================"
echo -e "|  SCPA Scores Data Converter  |"
echo -e "================================"

INPUT_FILE=$1

header="id,additional_info,call_number,collation,\
collection,composer,difficulty,duration,ensemble_description,\
ensemble_size,fair_use,imprint,instrumentation,pages,\
solo_difficulty,special,title"
